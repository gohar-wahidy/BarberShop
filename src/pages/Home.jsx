    ...
    <section id="home" className="min-h-screen flex items-center justify-center flex-grow p-4 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-left">
            ...
            I offer classic haircuts and clean straight razor shaves. Whether it’s a sharp fade or a clean shave, it's always <b>$20 cash flat</b>. No appointments — just walk in, sit down, and get fresh just like the good old days.
          </p>
